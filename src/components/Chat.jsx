...
//       mimeType,
//       fileSize,
//       photoUrl, // optional from backend
//     }) => {
//       setMessages((prev) => [
//         ...prev,
//         {
...
//           mimeType,
//           fileSize,
//           // ⭐ keep any photoUrl if backend sends it
...
//   // ⭐ derive partner info from first incoming message
...
//           {/* Chat card */}
//           <div className="flex min-h-[75vh] max-h-[80vh] flex-col overflow-hidden rounded-3xl bg-gradient-to-b from-slate-900/95 via-slate-900/98 to-black/95 shadow-[0_18px_40px_rgba(0,0,0,0.9)] backdrop-blur-xl ring-1 ring-white/10">
//             {/* HEADER */}
//             <div className="flex items-center gap-3 border-b border-slate-800/70 bg-slate-900/95 px-4 py-3">
//               {/* Avatar with photoUrl */}
//               <div className="avatar">
//                 <div className="w-10 rounded-full ring ring-offset-2 ring-offset-slate-900 ring-amber-400/80 overflow-hidden">
//                   {partnerPhotoUrl ? (
//                     <img
//                       src={partnerPhotoUrl}
//                       alt={partnerName}
...
//                     </span>
//                   ) : (
//                     <span className="inline-flex items-center gap-1 rounded-full bg-slate-800/60 px-2 py-0.5 text-[10px] font-medium text-slate-300/70">
//                       Offline
//                     </span>
//                   )}
//                 </div>
...
//                             className={
//                               isOwn
//                                 ? "ml-auto max-w-[80%] rounded-2xl bg-gradient-to-br from-amber-300 via-yellow-400 to-amber-500 px-3 py-2 text-xs text-neutral-900 shadow-lg shadow-amber-500/40"
//                                 : "mr-auto max-w-[80%] rounded-2xl bg-slate-800/90 px-3 py-2 text-xs text-slate-100 shadow-md"
//                             }
//                           >
//                             {bubbleContent}
//                             <div
...
//                                 isOwn
//                                   ? "justify-end text-neutral-900/75"
//                                   : "justify-between text-slate-300/75"
//                               }`}
//                             >
...
//                           {/* delete btn for own non-deleted messages */}
//                           {isOwn && !msg.isDeleted && (
//                             <button
...
//             {/* Last message status */}
//             {lastStatus && (
//               <div className="px-4 py-1 text-right text-[10px] text-slate-300/75 border-t border-slate-800/70 bg-slate-900/95">
...
//             {/* INPUT BAR */}
//             <form
//               className="border-t border-slate-800/70 bg-slate-900/95 px-3 py-2 sm:px-4 sm:py-3"
//               onSubmit={(e) => {
//                 e.preventDefault();
//                 handleSend();
//               }}
...
//                   className="btn btn-circle btn-ghost btn-xs sm:btn-sm border-none bg-slate-800/80 text-slate-200/80 hover:bg-slate-700"
//                 >
//                   <svg
...
//                   <div className="flex items-center rounded-2xl bg-slate-800/90 px-3 py-2 shadow-inner shadow-black/40">
//                     <textarea
//                       rows={1}
...
//                 <button
//                   type="submit"
//                   className="btn btn-circle border-none bg-gradient-to-tr from-amber-300 via-yellow-400 to-amber-500 text-neutral-900 shadow-lg shadow-amber-500/40 hover:brightness-110"
//                 >
//                   <svg
//                     xmlns="http://www.w3.org/2000/svg"
//                     className="h-4 w-4 sm:h-5 sm:w-5"
